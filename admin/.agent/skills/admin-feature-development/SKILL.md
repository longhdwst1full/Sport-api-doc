...
1. Identify the generated DTO/query/mutation and the stable view/action permission codes.
...
4. For lists, use server pagination/sort/filter and cancellation. For forms, isolate DTO/form mapping and render server validation errors.
5. Represent business transitions as named actions with confirmation, not direct status field edits.
6. Add tests for mapping, permissions and mutation outcomes; run the local quality gate.
