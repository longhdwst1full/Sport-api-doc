...
export const PRODUCT_AUDIT_ACTION = {
  ...
  MEDIA_DELETE_REQUEST: 'catalog.product-media.delete.request',
  MEDIA_DELETE: 'catalog.product-media.delete',
  MEDIA_DELETE_FAILED: 'catalog.product-media.delete.failed',
