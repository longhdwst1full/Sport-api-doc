...
- No ORM/database adapter is selected or implemented in the current base. Do not invent migrations/entities until relevant `document/08-open-decisions.csv` items and the delivery wave are reviewed.
